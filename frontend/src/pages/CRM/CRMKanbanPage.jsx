                            ...
                            >
                              <CardContent sx={{ p: '12px !important' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                  <Avatar sx={{ bgcolor: colDef.color, width: 24, height: 24, fontSize: '0.8rem', mr: 1 }}>
                                    {ciclo.paciente_nome?.charAt(0)}
                                  </Avatar>
                                  <Typography variant="subtitle2" noWrap sx={{ fontWeight: 'bold', maxWidth: '180px' }}>
                                    {ciclo.paciente_nome}
                                  </Typography>
                                </Box>
                                ...
                                <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                                  <Typography variant="caption" color="text.secondary">
                                    {new Date(ciclo.data_inicio).toLocaleDateString()}
                                  </Typography>
                                  {parseFloat(ciclo.receita_acumulada) > 0 && (
                                    <Chip 
                                      label={`R$ ${ciclo.receita_acumulada}`} 
                                      size="small" 
                                      color="success" 
                                      variant="outlined" 
                                ...
                                {ciclo.proxima_acao_imediata ? (
                                  <Box sx={{ 
                                    mt: 1, p: 0.5, 
                                    backgroundColor: ciclo.proxima_acao_imediata.atrasada ? '#ffebee' : '#f5f5f5', 
