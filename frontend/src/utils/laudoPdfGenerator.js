...
export const gerarPDFLaudo = async ({
    ...
    if (usaAssinaturaDigital) {
        ...
        elementoAssinatura = {
            absolutePosition: { x: 40, y: 720 }, // Fixa exatamente no rodapé da folha A4
            table: {
                widths: ['auto', '*', 'auto'], 
                body: [[
                    {
    ...
    // Insere um espaçador invisível de 80 pontos. 
    // Isso garante que se o texto for muito longo, o pdfMake quebra a página 
    // ANTES de escrever a assinatura, evitando que fiquem sobrepostos.
