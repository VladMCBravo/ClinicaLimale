...
export const gerarPDFLaudo = async ({
    ...
    if (usaAssinaturaDigital) {
        ...
        elementoAssinatura = {
            // O margin top afasta do conteúdo anterior. A borda superior cria a linha separadora.
            margin: [0, 20, 0, 0],
            table: {
                widths: ['auto', '*', 'auto'], // 3 colunas: QR, Texto, Logo
                body: [[
                    // Coluna 1: QR Code
                    {
                        qr: urlValidacaoQR, 
                        fit: 55, // Tamanho do QR Code
                        alignment: 'left',
                        margin: [0, 5, 0, 0],
                        border: [false, true, false, false], // Borda superior apenas
                        borderColor: ['#999', '#999', '#999', '#999']
                    },
                    // Coluna 2: Textos (Estilo Memed)
                    {
                        stack: [
                        ...
                        alignment: 'left',
                        margin: [10, 8, 0, 0],
                        border: [false, true, false, false], // Borda superior
                        borderColor: ['#999', '#999', '#999', '#999']
                    },
                    // Coluna 3: Logo ICP-Brasil em Base64
                    {
                        image: logoIcpBase64,
            ...
            layout: { 
                defaultBorder: false // Desliga as bordas padrão, usamos as específicas acima
            },
            unbreakable: true // Evita que o rodapé quebre no meio
        };
    } else {
        elementoAssinatura = {
            stack: [
