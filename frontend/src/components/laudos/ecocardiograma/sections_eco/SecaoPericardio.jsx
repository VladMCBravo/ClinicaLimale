    ...
    <div className="laudo-section">
        ...
        <div className="laudo-section-body">
            ...
            <div style={{display:'flex', gap:'15px', flexWrap: 'wrap'}}>
                ...
                <div style={{flex: 1, minWidth: '200px', borderLeft:'1px solid #eee', paddingLeft:'10px', opacity: temDerrame ? 1 : 0.5, pointerEvents: temDerrame ? 'auto' : 'none'}}>
                    <div style={{fontSize:'10px', fontWeight:'bold', color:'#999', marginBottom:'5px'}}>Características</div>
            ...
            {/* RODAPÉ: REPERCUSSÃO */}
            <div style={{marginTop:'10px', border:'1px solid #f0f0f0', padding:'5px', opacity: temDerrame ? 1 : 0.5, pointerEvents: temDerrame ? 'auto' : 'none'}}>
                <div style={{fontSize:'10px', fontWeight:'bold', color:'#999', marginBottom:'5px'}}>Repercussão hemodinâmica do derrame</div>
                <div className="laudo-row" style={{flexWrap: 'wrap'}}>
                    ...
                    <label className="laudo-checkbox-label" style={{marginRight:'15px'}}>
                        <input type="radio" name="periRepercussao" value="sem_repercussao" checked={data.periRepercussao === 'sem_repercussao'} onChange={handleChange} /> ausente
                    </label>
                    <label className="laudo-checkbox-label">
                        <input type="radio" name="periRepercussao" value="com_repercussao" checked={data.periRepercussao === 'com_repercussao'} onChange={handleChange} /> presente
                    </label>
                </div>
            </div>
