...
export default function AlertasClinicos({ anamnese }) {
    ...
    return (
        <Paper variant="outlined" sx={{ p: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}><WarningAmberIcon color="warning" /><Typography variant="h6" sx={{ fontSize: '1rem', fontWeight: 'bold' }}>Alertas Clínicos</Typography></Box>
            <Divider />
            <Box sx={{ pt: 1.5 }}>
