...
class ChatbotValidators:
    ...
    def validar_email_avancado(email: str) -> Tuple[bool, str, Optional[str]]:
        ...
        # Verifica domínios comuns com erros de digitação - otimizado
        ...
        if dominio in dominios_errados:
            return False, f"Você quis dizer {email.replace(dominio, dominios_errados[dominio])}?", None
    ...
    def validar_data_nascimento_avancada(data_str: str) -> Tuple[bool, str, Optional[date]]:
        ...
        # Tenta diferentes formatos - otimizado
